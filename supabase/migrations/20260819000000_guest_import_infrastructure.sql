    ...
    if p_profile is not null then
        ...
        if found then
            ...
            insert into public.profiles (
                ...
                p_profile #>> '{data,sex}',
                (p_profile #>> '{data,height_cm}')::double precision,
                ...
                p_profile #>> '{data,goal}',
                (p_profile #>> '{data,daily_calorie_goal}')::double precision,
                (p_profile #>> '{data,protein_goal}')::double precision,
                (p_profile #>> '{data,carbs_goal}')::double precision,
                (p_profile #>> '{data,fat_goal}')::double precision,
                (p_profile #>> '{data,fiber_goal}')::double precision,
